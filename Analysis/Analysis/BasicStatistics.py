...
if __name__ == '__main__':
    ...
    #       We provided a pre-computed record as "Data/plot_data/basic_statistics.npy".
    # =================================================================================

    print("=" * 50)
    # Read data
    all_data = pickle.load(open("../../Data/fitted_data/05-Sep-2019-example_data.pkl", "rb"))
    ...
    print("-" * 50)
    # Save data
    np.save("../../Data/plot_data/basic_statistics.npy", {"Omega":omega_records, "Patamon":patamon_records})
